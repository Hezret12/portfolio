...
const experience = [
  {
    ...
    type: "Freelance",
    companyIcon: "icon-park-twotone:robot-two",
    companyColor: "from-green-500 to-green-600",
    description: "Delivered high-quality projects across diverse domains, including web, API development, and cloud integrations (AWS, GCP).",
    achievements: [
    ...
    technologies: ["JavaScript","Node.js","WordPress","Python","Web Scraping"]
  },
  {
    role: "Frontend Developer",
    company: "Beyik Yupek Yoly",
    period: "October 2024 — May 2025",
    type: "Part-time",
    companyColor: "from-blue-500 to-blue-600",
    companyIcon: "cbi:toyota",
    description: "Developed and optimized a modern Admin Panel to replace outdated manual workflows, enabling seamless data management, analytics, and user role control with an intuitive UI.",
    achievements: [
    "Designed and implemented role-based access control for secure user management",
    "Integrated dashboards with real-time analytics and activity monitoring",
    "Optimized CRUD operations with responsive and accessible UI components",
    "Collaborated with backend teams to ensure reliable API integration",
