    ...
    >
      ...
      <div className="max-w-none">
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          Hello, World! I am Hezret Meretgylyjov — a passionate Frontend Developer & UI/UX enthusiast
          dedicated to creating high-performance, user-centric software solutions with intuitive and engaging designs.
        </p>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
          With 1.5+ years of experience, I specialize in building scalable web and mobile applications using
